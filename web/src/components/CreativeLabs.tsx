...
const LANGUAGES: LanguageSample[] = [
  {
    name: "English", code: "en", native: "English", flag: "🇬🇧", category: "European",
  ...
  {
    name: "French", code: "fr", native: "Français", flag: "🇫🇷", category: "European",
  ...
  {
    name: "German", code: "de", native: "Deutsch", flag: "🇩🇪", category: "European",
    samples: [{ title: "Wandrers Nachtlied II", author: "J.W. von Goethe", content: "[whispers] Über allen Gipfeln ist Ruh, in allen Wipfeln spürest du kaum einen Hauch; [softly] die Vögelein schweigen im Walde. Warte nur, balde ruhest du auch." }]
  },
  {
    name: "Spanish", code: "es", native: "Español", flag: "🇪🇸", category: "European",
  ...
  {
    name: "Italian", code: "it", native: "Italiano", flag: "🇮🇹", category: "European",
  ...
  {
    name: "Hungarian", code: "hu", native: "Magyar", flag: "🇭🇺", category: "European",
  ...
  {
    name: "Russian", code: "ru", native: "Русский", flag: "🇷🇺", category: "Slavic",
    samples: [{ title: "Eugene Onegin", author: "Alexander Pushkin", content: "[serious] Я к вам пишу — чего же боле? Что я могу еще сказать? [whispers] Теперь, я знаю, в вашей воле Меня презреньем наказать." }]
  },
  {
    name: "Ukrainian", code: "uk", native: "Українська", flag: "🇺🇦", category: "Slavic",
    samples: [{ title: "Zapovit", author: "Taras Shevchenko", content: "[dramatically] Як умру, то поховайте Мене на могилі Серед степу широкого На Вкраїні милій." }]
  },
  {
    name: "Polish", code: "pl", native: "Polski", flag: "🇵🇱", category: "Slavic",
    samples: [{ title: "Pan Tadeusz", author: "Adam Mickiewicz", content: "[happy] Litwo! Ojczyzno moja! ty jesteś jak zdrowie. [whispers] Ile cię trzeba cenić, ten tylko się dowie, Kto cię stracił." }]
  },
  {
    name: "Esperanto", code: "eo", native: "Esperanto", flag: "🟢", category: "Experimental",
    samples: [{ title: "La Espero", author: "L. L. Zamenhof", content: "[excited] En la mondon venis nova sento, tra la mondo iras forta voko; [whispers] per flugiloj de facila vento nun de loko flugu ĝi al loko." }]
  },
  {
    name: "Klingon", code: "tlh", native: "tlhIngan Hol", flag: "⚔️", category: "Experimental",
    samples: [{ title: "Warrior's Creed", author: "Klingon Empire", content: "[serious] tlhIngan Hol Dajatlh'a'? [angry] Heghlu'meH QaQ jajvam!" }]
  },
  {
    name: "Sindarin", code: "sjn", native: "Sindarin (Elvish)", flag: "🧝", category: "Experimental",
    samples: [{ title: "Meeting Star", author: "J.R.R. Tolkien", content: "[whispers] Elen síla lúmenn' omentielvo. A star shines on the hour of our meeting." }]
  },
  {
    name: "Latin", code: "la", native: "Latina", flag: "🏛️", category: "Classical",
  ...
  {
    name: "Classical Greek", code: "grc", native: "Ἑλληνική", flag: "📜", category: "Classical",
    samples: [{ title: "Odyssey", author: "Homer", content: "Ἄνδρα μοι ἔννεπε, Μοῦσα, πολύτροπον, ὃς μάλα πολλὰ πλάγχθη, ἐпеὶ Τροίης ἱερὸн πτολίεθρον ἔπερσεν." }]
  },
  {
    name: "Ancient Sumerian", code: "sux", native: "𒅴𒂠", flag: "🏺", category: "Classical",
    samples: [{ title: "En-metena", author: "Lagash", content: "Ningirsu-ra, En-metena-ke, E-ninnu-mu-na-du. For Ningirsu, En-metena built the Eninnu." }]
  },
  {
    name: "Hindi", code: "hi", native: "हिन्दी", flag: "🇮🇳", category: "Global",
  ...
  {
    name: "Cantonese", code: "zh-HK", native: "廣東話", flag: "🇭🇰", category: "Global",
    samples: [{ title: "Quiet Night", author: "Li Bai (Cantonese)", content: "床前明月光，疑是地上霜。舉頭望明月，低頭思故鄉。" }]
  },
  {
    name: "Kiswahili", code: "sw", native: "Kiswahili", flag: "🇰🇪", category: "Global",
  ...
  {
    name: "Tagalog", code: "tl", native: "Tagalog", flag: "🇵🇭", category: "Global",
    ...
    <div className="h-full space-y-8 animate-in fade-in duration-700">
          ...
          <div className="glass-card w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden border-white/10 shadow-2xl">
            <header className="p-8 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
              <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Linguistic Library</h2>
                    <p className="text-xs font-bold text-white/30 uppercase tracking-[0.2em]">Zero-Shot Multilingual Mastery</p>
                </div>
              </div>
              <button 
                type="button"
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-12">
                {["European", "Slavic", "Classical", "Experimental", "Global"].map(category => {
                    const langs = filteredLanguages.filter(l => l.category === category);
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {langs.map(l => (
                                    ...
                                    >
                                        ...
                                        <div className={`font-black uppercase tracking-tighter ${selectedLang.code === l.code ? "text-white" : "text-white/80"}`}>
                                            {l.name}
                                        </div>
                                        <div className={`text-[10px] font-bold uppercase tracking-widest ${selectedLang.code === l.code ? "text-white/60" : "text-white/30"}`}>
                                            {l.native}
                                        </div>
                                    </button>
                                ))}
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { id: "neko", title: "Wagahai wa Neko", desc: "Japanese literary reading via Gemini 3.1 Flash.", icon: "🐈", color: "border-emerald-500/20", btn: "bg-emerald-600" },
            { id: "shakespeare", title: "The Bard's Soliloquy", desc: "Dramatic Hamlet monologue with Charon voice.", icon: "🎭", color: "border-violet-500/20", btn: "bg-violet-600" },
            { id: "price", title: "The Price Experience", desc: "Sinister horror narration via Hume Octave.", icon: "🦇", color: "border-rose-500/20", btn: "bg-rose-600" },
          ].map((d) => (
            <div key={d.id} className={`glass-card p-6 flex flex-col justify-between border ${d.color} hover:bg-white/[0.04] transition-all group`}>
              <div>
                <div className="text-3xl mb-4 group-hover:scale-110 transition-transform origin-left">{d.icon}</div>
                <h3 className="text-base font-black text-white uppercase tracking-tighter mb-2">{d.title}</h3>
                <p className="text-xs text-white/40 leading-relaxed font-bold uppercase tracking-wide">{d.desc}</p>
              </div>
              <button
                type="button"
        ...
        <div className="lg:col-span-8 space-y-6">
            <div className="glass-card p-8">
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-lg font-black text-white uppercase tracking-tighter">Polyglot Lab</h2>
                            <p className="text-[10px] font-bold text-white/30 uppercase tracking-[0.2em]">{selectedLang.name} Mastery</p>
                        </div>
                    </div>
                    ...
                    {selectedLang.samples.map((s) => (
                        ...
                        >
                            <div className={`text-[10px] font-black uppercase tracking-widest mb-1 ${selectedSample.title === s.title ? "text-violet-400" : "text-white/40"}`}>
                                {selectedSample.title === s.title ? "Active Sample" : selectedLang.native}
                            </div>
                            <div className="font-black text-white text-sm truncate">{s.title}</div>
                            <div className="text-xs text-white/40 truncate mt-0.5">{s.author}</div>
                        </button>
                    ))}
                </div>
                ...
                <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-8 relative">
                    ...
                    {isConnecting && (
                        <div className="absolute bottom-4 left-8 animate-pulse flex items-center gap-2">
                           ...
                           <span className="text-[10px] font-black text-violet-400 uppercase tracking-widest">Warming up neural stream...</span>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="glass-card p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="english-input" className="block text-xs font-bold text-white/50 uppercase tracking-wider mb-2">English Input</label>
                  <textarea
                    id="english-input"
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <label htmlFor="tagalog-output" className="text-xs font-bold text-emerald-400 uppercase tracking-wider">Tagalog Output</label>
                  </div>
                  <div id="tagalog-output" className="w-full bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-4 text-emerald-100 text-xl font-black min-h-[120px] flex items-center justify-center">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="glass-card p-6">
            ...
            <div className="space-y-3">
              {TONGUE_TWISTERS.map((tt) => (
                <div key={tt} className="bg-white/[0.03] border border-white/8 rounded-xl p-4 hover:border-violet-500/30 transition-all">
          ...
          <div className="glass-card p-6 border-violet-500/20">
            ...
            <div className="space-y-2">
              {[
                { label: "Engine", value: "Gemini 3.1", color: "text-blue-400" },
                { label: "Stability", value: "Neural v5", color: "text-violet-400" },
                { label: "Polyglot", value: "Enabled", color: "text-emerald-400" },
                { label: "Prosody", value: `${emotion}%`, color: "text-amber-400" },
              ].map((s) => (
      ...
      {streamData && (
        <div className="fixed bottom-8 right-8 z-50 w-full max-w-md">
          <StreamPlayback
            ...
            provider={streamData.provider as any}
